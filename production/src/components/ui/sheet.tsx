/**
 * Sheet — slide-out panel (drawer). Built on Radix Dialog.
 *
 * Use for: mobile sidebar, notification panel, filter drawer, customer detail drawer.
 *
 * @example
 * <Sheet>
 *   <SheetTrigger asChild><Button>Open notifications</Button></SheetTrigger>
...
const SheetHeader = ({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) => (
  <div
    className={cn(
      "flex flex-col gap-1 text-left p-6 border-b border-hairline",
      className
    )}
    {...props}
  />
...
const SheetFooter = ({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) => (
  <div
    className={cn(
      "flex flex-col-reverse gap-2 sm:flex-row sm:justify-end p-6 border-t border-hairline",
      className
    )}
    {...props}
  />
